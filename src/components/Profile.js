...
function Profile() {
  ...
  return (
    <Flex direction={isNotSmallerScreen?"row":"column"} w="100%" maxWidth={{base:"100vh", md:"130vh", lg:"130vh", xl:"130vh"}}>
        ...
        <Flex direction={isNotSmallerScreen?"row":"column"} mt={8} minW={'30vh'}>
            <Flex rounded="xl" direction="column" mt={4} mr={2} bg="blue.400" justify="flex-end">
                <Icon color="white" p="4" as={DiAndroid} w="24" h="24"/>
                <Text color="white" p="4" fontSize="xl" fontWeight="semibold">
                    Android Apps
                </Text>
            </Flex>
            <Flex rounded="xl" direction="column" mt={4} mr={2} bg="gray.100" justify="flex-end" _hover={{bg: "green.400"}}>
                <Icon color="black" p="4" as={DiCodeigniter} w="24" h="24"/>
                <Text color="black" p="4" fontSize="xl" fontWeight="semibold">
                    Flutter Apps
                </Text>
            </Flex>
            <Flex rounded="xl" direction="column" mt={4} bg="gray.100" justify="flex-end" _hover={{bg: "teal.400"}}>
